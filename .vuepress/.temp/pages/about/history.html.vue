...
2024-07-13：加了12新作前的所有台版专辑官方简介和内页扫描，增加搜索</p>
...
<li>20230604：结构没干完（但干了），重新梳理了导航，补充了侧边栏。</li>
<li>20230603：增加了歌迷组织，加了评论插件（但有bug，懒得研究凑合用）</li>
<li>20240530：争取今天把所有文件结构创建清楚，然后把侧边栏创建完成。首页....拉倒吧，再说（或者把首页改完）<br>
侧边栏文件：sidebar.ts<br>
collapsible：是否折叠</li>
<li>20240714：证明一下我还在更新</li>
</ul>
...
<li>顶部导航调整（完成啦...吧）</li>
<li>侧边导航调整（完成啦...吧）</li>
<li>未开演唱会站点专题（目录结构不够清晰）</li>
<li>填充内容（长期）</li>
<li>评论插件（待处理bug：提示缺少js）（更新全部依赖 他就不报错了....）</li>
<li>github项目（长期）</li>
<li>图库（搁置）</li>
<li>公共资源库（已开始）</li>
</ul>
